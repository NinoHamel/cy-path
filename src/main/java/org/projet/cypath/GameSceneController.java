...
public class GameSceneController {
    ...
    /**
     Starts the game and returns the JavaFX Scene using {@link #createCheckerboard()},
    ...
    public Scene start() {
        ...
        GridPane checkerboard = createCheckerboard();

        StackPane rootPane = new StackPane();
        rootPane.getChildren().add(checkerboard);
    ...
    /**
     ...
     {@link #initializeButtons(GridPane, AtomicReference, AtomicReference, AtomicReference, AtomicReference, List, AtomicInteger)},
     @return The created GridPane.
     */
    private GridPane createCheckerboard() {
        ...
        initializeButtons(gridPane, actionMove, actionWall, horizontalWall, verticalWall,listOnGoing,index);
     ...
     *moveButton using {@link #createMoveButton(GridPane, AtomicReference, AtomicReference, AtomicReference, AtomicReference, Button, Button, List, AtomicInteger)}
     *placeWallButton using {@link #createplaceWallButton(GridPane, AtomicReference, AtomicReference, AtomicReference, AtomicReference, Button, Button, List, AtomicInteger)}
     *@param gridPane The GridPane representing the game board.
     ...
     */
    private void initializeButtons(GridPane gridPane, AtomicReference<Boolean> actionMove,
        ...
        Button moveButton = createMoveButton(gridPane, actionMove, actionWall, horizontalWall, verticalWall,
                horizontalWallButton,verticalWallButton,listOnGoing, index);
        Button placeWallButton = createplaceWallButton(gridPane, actionMove, actionWall, horizontalWall, verticalWall,
        horizontalWallButton,verticalWallButton,listOnGoing,index);
        gridPane.add(moveButton, checkerboard_SIZE, 0);
        gridPane.add(placeWallButton, checkerboard_SIZE, 1);
    }
    /**
     *Creates a button for initiating the movement mode.
     *@param gridPane The GridPane representing the game board.
     *@param actionMove An AtomicReference<Boolean> representing the actionMove flag (set to true).
     *@param actionWall An AtomicReference<Boolean> representing the actionWall flag (set to false).
     ...
     *@param listOnGoing The list of players who are still playing.
     *@param index The index of the current player in the listOnGoing.
     *@return The created Button for initiating movement.
     */
    private Button createMoveButton(GridPane gridPane, AtomicReference<Boolean> actionMove,
                                      AtomicReference<Boolean> actionWall, AtomicReference<Boolean> horizontalWall,
    ...
    Button moveButton = new Button("Bouger");
        moveButton.setOnAction(event -> {
            actionMove.set(true);
            actionWall.set(false);
            gridPane.getChildren().remove(horizontalWallButton);
            gridPane.getChildren().remove(verticalWallButton);
     ...
     */
    private Button createplaceWallButton(GridPane gridPane, AtomicReference<Boolean> actionMove, AtomicReference<Boolean> actionWall,
        ...
        Button placeWallButton = new Button("Placer murs");
        placeWallButton.setOnAction(event -> {
            if(!actionWall.get()) {
                gridPane.add(horizontalWallButton, checkerboard_SIZE, 2);
                gridPane.add(verticalWallButton, checkerboard_SIZE, 3);
            }
    ...
    private Button createhorizontalWallButton(AtomicReference<Boolean> horizontalWall, AtomicReference<Boolean> verticalWall) {
        Button horizontalWallButton = new Button("horizontalWall");
